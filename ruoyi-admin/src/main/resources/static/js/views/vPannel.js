...
function init_wcmenu() {
    $.ajax({
        type: "GET",
        url: "/api/Wcmenu/mname",
        dataType: "json",
        success: function (data) {
            var wcgroup_data = data.data;
            var x_data = new Array();
            for (x in wcgroup_data) {
                x_data.push(wcgroup_data[x].mname);
            }

            var wcmenu_data = echarts.init(document.getElementById('wcmenu_data'));
            ...
            option = {
                ...
                series: [{
                    ...
                    data:[
                        {value:1, name:x_data[0]},
                        {value:1, name:x_data[1]},
                        {value:1, name:x_data[2]},
                        {value:1, name:x_data[3]},
                        {value:1, name:x_data[4]},
                        {value:1, name:x_data[5]},
                        {value:1, name:x_data[6]},
                        {value:1, name:x_data[7]},
                        {value:1, name:x_data[8]},
                        {value:1, name:x_data[9]},
                        {value:1, name:x_data[10]},
                        {value:1, name:x_data[11]},
                        {value:1, name:x_data[12]},
                        {value:1, name:x_data[13]},
                        {value:1, name:x_data[14]},
                        {value:1, name:x_data[15]},
                        {value:1, name:x_data[16]},
                    ],
                    itemStyle: itemStyle
                }]
            };

            wcmenu_data.setOption(option);
        }
    });
}
