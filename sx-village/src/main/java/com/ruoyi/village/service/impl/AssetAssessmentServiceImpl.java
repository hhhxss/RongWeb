...
public class AssetAssessmentServiceImpl implements IAssetAssessmentService
{
	...
	public List<AssetAssessment> selectAssetAssessmentBytype() {
		return assetAssessmentMapper.selectAssetAssessmentBytype();
	}

	@Override
	@DataSource(value = DataSourceType.SXBAODIAN)
	public List<AssetAssessment> selectAssetAssessmentGtype() {
		return assetAssessmentMapper.selectAssetAssessmentGtype();
	}

    @Override
    @DataSource(value = DataSourceType.SXBAODIAN)
    public List<AssetAssessment> selectAssetAssessmentButype() {
        return assetAssessmentMapper.selectAssetAssessmentButype();
    }

    @Override
    @DataSource(value = DataSourceType.SXBAODIAN)
    public List<AssetAssessment> selectAssetAssessmentHotype() {
        return assetAssessmentMapper.selectAssetAssessmentHotype();
    }

    @Override
    @DataSource(value = DataSourceType.SXBAODIAN)
    public List<AssetAssessment> selectAssetAssessmentPutype() {
        return assetAssessmentMapper.selectAssetAssessmentPutype();
    }

    @Override
    @DataSource(value = DataSourceType.SXBAODIAN)
    public List<AssetAssessment> selectAssetAssessmentTwtype() {
        return assetAssessmentMapper.selectAssetAssessmentTwtype();
    }

    @Override
    @DataSource(value = DataSourceType.SXBAODIAN)
    public List<AssetAssessment> selectAssetAssessmentOttype() {
        return assetAssessmentMapper.selectAssetAssessmentOttype();
    }

	@Override
	@DataSource(value = DataSourceType.SXBAODIAN)
	public List<AssetAssessment> selectAssetAssessmentSctype() {
		return assetAssessmentMapper.selectAssetAssessmentSctype();
	}

	@Override
	@DataSource(value = DataSourceType.SXBAODIAN)
	public List<AssetAssessment> selectAssetAssessmentWctype() {
		return assetAssessmentMapper.selectAssetAssessmentWctype();
	}
}
